    ...
    while True:
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                elif((keys_pressed[pygame.K_RALT] or keys_pressed[pygame.K_LALT]) and keys_pressed[pygame.K_F4]) or keys_pressed[pygame.K_ESCAPE]: sys.exit()
